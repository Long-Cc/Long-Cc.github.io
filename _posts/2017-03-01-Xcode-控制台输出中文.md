...
创建一个字典并输出:
    ...
    NSDictionary *dic = @{@"name"  : @"Belial",
                           ...
                           @"set"     : set,
                           @"Unicode" : @"😀😁🤣😂😄",
                           @"contact" : @[@"Belial Blog:http://qiubaiying.top",
...
输出结果：
	...
	2017-03-01 10:36:45.709 BelialFoundationLog_Demo[1657:53604] {
	    "My bolg" = "http://qiubaiying.top";
	    Unicode = "\Ud83d\Ude00\Ud83d\Ude01\Ud83e\Udd23\Ud83d\Ude02\Ud83d\Ude04";
	    contact =     (
	        "Belial Blog:http://qiubaiying.top",
	        "GitHub:https://github.com/qiubaiying",
...
将`BYFoundationLog.m`拖入项目，再次运行
	...
	2017-03-01 10:35:52.545 BelialFoundationLog_Demo[1635:52772] 	{
		set = 	{(
			"str -> data格式的字符串",
			"set0",
				{
